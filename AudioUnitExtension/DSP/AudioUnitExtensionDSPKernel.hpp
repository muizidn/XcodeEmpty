//
//  AudioUnitExtensionDSPKernel.hpp
//  AudioUnitExtension
//
...
#ifndef AudioUnitExtensionDSPKernel_hpp
#define AudioUnitExtensionDSPKernel_hpp
...
/*
 AudioUnitExtensionDSPKernel
 Performs simple copying of the input signal to the output.
 As a non-ObjC class, this is safe to use from render thread.
 */
class AudioUnitExtensionDSPKernel : public DSPKernel {
public:
...
#endif /* AudioUnitExtensionDSPKernel_hpp */
