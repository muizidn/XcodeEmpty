//
//  AudioUnitExtensionAudioUnit.swift
//  AudioUnitExtension
//
...
public class AudioUnitExtensionAudioUnit: AUAudioUnit {

    private let parameters: AudioUnitExtensionParameters
    private let kernelAdapter: AudioUnitExtensionDSPKernelAdapter
    ...
    public override init(componentDescription: AudioComponentDescription,
        ...
        kernelAdapter = AudioUnitExtensionDSPKernelAdapter()

        // Create parameters object to control paramOne
        parameters = AudioUnitExtensionParameters(kernelAdapter: kernelAdapter)
